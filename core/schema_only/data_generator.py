...
class DataGenerator:
    ...
    def generate_data_for_config(self, config: Dict[str, Any], output_dir: str, row_count: int = 100):
        """
    ...
    def _generate_table_data(self, table_config: Dict[str, Any], row_count: int) -> List[Dict[str, Any]]:
        data = []
    ...
    def _generate_value(self, col_name: str, col_constraints: List[str], mappings: List[Dict[str, Any]]) -> Any:
    ...
    def _write_csv(self, filepath: str, data: List[Dict[str, Any]], table_config: Dict[str, Any]):
        if not data:
            return
