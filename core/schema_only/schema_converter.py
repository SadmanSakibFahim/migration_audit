...
class SchemaConverter:
    ...
    def convert_to_config(
        self, schema_path: str, format: str = "sql"
    ) -> Dict[str, Any]:
        """
    ...
    def _parse_sql_columns(self, body: str) -> Dict[str, Any]:
        ...
        for line in lines:
            if (
                ...
                or line.upper().startswith("FOREIGN KEY")
            ):
                continue
            ...
            is_pk = False
            if (
                "PRIMARY" in line.upper() and "KEY" in line.upper()
    ...
    def _parse_json_schema(self, content: str) -> Dict[str, Any]:
        ...
        if "properties" in schema:
            ...
            config["tables"][table_name] = (
                self._convert_json_properties_to_table_config(schema, table_name)
            )

        return config

    def _convert_json_properties_to_table_config(
        self, schema_node: Dict[str, Any], table_name: str
    ) -> Dict[str, Any]:
        constraints = {}
