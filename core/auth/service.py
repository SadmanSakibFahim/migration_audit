...
from core.auth.models import User, License, Subscriber, Enterprise, ApiKey
...
class AuthService:
    ...
    def create_license(self, key_hash: str, valid_from: datetime, valid_until: datetime, plan="basic") -> License:
        lic = License(
            key_hash=key_hash,
    ...
    def create_user(self, username: str, password: str, subscriber_id: int, role: UserRole = UserRole.VIEWER) -> User:
        user = User(
            username=username,
