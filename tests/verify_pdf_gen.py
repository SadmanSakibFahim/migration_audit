...
def run_verification():
    ...
    results = [
        ...
        TestResult(
            ...
            message="5 users found with weak passwords.",
            details="User IDs: 101, 102...",
        ),
        TestResult(
            name="Encryption Check",
            status=CheckStatus.WARN,
            message="Encryption at rest verified but using old algorithm.",
        ),
        TestResult(
        ...
        TestResult(
            ...
            status=CheckStatus.FAIL,
            message="Found 150 orphaned records in Orders table.",
        ),
    ]
