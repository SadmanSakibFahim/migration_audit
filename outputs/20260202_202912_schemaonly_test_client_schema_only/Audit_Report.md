...
- Sum Check: orders - user_id
- Average Check: orders - user_id
- Max Check: orders - user_id
- Min Check: orders - user_id
- Variance Check: orders - user_id
...
- **[PASS]** Variance matches exactly for column 'id' in table 'orders'. Source and Target both have variance 35.0.
  - Details: {'pct_difference': np.float64(0.0)}
- **[WARN]** Source sum for column 'user_id' in table 'orders' is zero.
- **[WARN]** Source average for column 'user_id' in table 'orders' is zero.
- **[WARN]** Source max for column 'user_id' in table 'orders' is zero.
- **[WARN]** Source min for column 'user_id' in table 'orders' is zero.
- **[WARN]** Source variance for column 'user_id' in table 'orders' is zero.
- **[PASS]** Sum matches exactly for column 'amount' in table 'orders'. Source and Target both have sum 5661.43.
  - Details: {'pct_difference': np.float64(0.0)}
- **[PASS]** Average matches exactly for column 'amount' in table 'orders'. Source and Target both have average 283.0715.
  - Details: {'pct_difference': np.float64(0.0)}
- **[PASS]** Max matches exactly for column 'amount' in table 'orders'. Source and Target both have max 494.18.
  - Details: {'pct_difference': np.float64(0.0)}
- **[PASS]** Min matches exactly for column 'amount' in table 'orders'. Source and Target both have min 137.07.
  - Details: {'pct_difference': np.float64(0.0)}
- **[PASS]** Variance matches exactly for column 'amount' in table 'orders'. Source and Target both have variance 11371.30902394737.
  - Details: {'pct_difference': np.float64(0.0)}
