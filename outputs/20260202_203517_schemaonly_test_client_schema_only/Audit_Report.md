...
- **[PASS]** Sum matches exactly for column 'amount' in table 'orders'. Source and Target both have sum 5222.65.
  - Details: {'pct_difference': np.float64(0.0)}
- **[PASS]** Average matches exactly for column 'amount' in table 'orders'. Source and Target both have average 261.1325.
  - Details: {'pct_difference': np.float64(0.0)}
- **[PASS]** Max matches exactly for column 'amount' in table 'orders'. Source and Target both have max 492.27.
  - Details: {'pct_difference': np.float64(0.0)}
- **[PASS]** Min matches exactly for column 'amount' in table 'orders'. Source and Target both have min 24.16.
  - Details: {'pct_difference': np.float64(0.0)}
- **[PASS]** Variance matches exactly for column 'amount' in table 'orders'. Source and Target both have variance 24891.45431447368.
  - Details: {'pct_difference': np.float64(0.0)}
