...
- **[PASS]** Variance matches exactly for column 'id' in table 'orders'. Source and Target both have variance 35.0.
  - Details: {'pct_difference': np.float64(0.0)}
- **[PASS]** Sum matches exactly for column 'amount' in table 'orders'. Source and Target both have sum 5609.3.
  - Details: {'pct_difference': np.float64(0.0)}
- **[PASS]** Average matches exactly for column 'amount' in table 'orders'. Source and Target both have average 280.46500000000003.
  - Details: {'pct_difference': np.float64(0.0)}
- **[PASS]** Max matches exactly for column 'amount' in table 'orders'. Source and Target both have max 488.76.
  - Details: {'pct_difference': np.float64(0.0)}
- **[PASS]** Min matches exactly for column 'amount' in table 'orders'. Source and Target both have min 36.42.
  - Details: {'pct_difference': np.float64(0.0)}
- **[PASS]** Variance matches exactly for column 'amount' in table 'orders'. Source and Target both have variance 19268.22880526316.
  - Details: {'pct_difference': np.float64(0.0)}
