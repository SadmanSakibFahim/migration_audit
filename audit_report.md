...
- **[FAIL]** Row count difference exceeds tolerance for table 'users'. Source: 102, Target: 100, Loss: 1.96%.
- **[FAIL]** Row count difference exceeds tolerance for table 'orders'. Source: 102, Target: 100, Loss: 1.96%.
- **[FAIL]** Row count difference exceeds tolerance for table 'order_items'. Source: 102, Target: 100, Loss: 1.96%.
- **[FAIL]** Row count difference exceeds tolerance for table 'products'. Source: 102, Target: 100, Loss: 1.96%.
...
- **[FAIL]** Mapping issues found in table 'users': Column 'status' in table 'users' has invalid values: [nan].
  - Details: {'issues': ["Column 'status' in table 'users' has invalid values: [nan]."]}
...
- **[FAIL]** Mapping issues found in table 'orders': Column 'order_status' in table 'orders' has invalid values: [nan].
  - Details: {'issues': ["Column 'order_status' in table 'orders' has invalid values: [nan]."]}
- **[FAIL]** Mapping issues found in table 'orders': Column 'payment_method' in table 'orders' has invalid values: [nan].
  - Details: {'issues': ["Column 'payment_method' in table 'orders' has invalid values: [nan]."]}
- **[FAIL]** Mapping issues found in table 'order_items': Column 'fulfillment_status' in table 'order_items' has invalid values: [nan].
  - Details: {'issues': ["Column 'fulfillment_status' in table 'order_items' has invalid values: [nan]."]}
- **[FAIL]** Mapping issues found in table 'products': Column 'category' in table 'products' has invalid values: [nan].
  - Details: {'issues': ["Column 'category' in table 'products' has invalid values: [nan]."]}
- **[FAIL]** Mapping issues found in table 'products': Column 'status' in table 'products' has invalid values: [nan].
  - Details: {'issues': ["Column 'status' in table 'products' has invalid values: [nan]."]}
...
- **[FAIL]** Data constraint issues found in table 'users': Column 'first_name' has 100 null values out of 100 rows.
  - Details: {'issues': ["Column 'first_name' has 100 null values out of 100 rows."]}
- **[FAIL]** Data constraint issues found in table 'users': Column 'last_name' has 100 null values out of 100 rows.
  - Details: {'issues': ["Column 'last_name' has 100 null values out of 100 rows."]}
- **[FAIL]** Data constraint issues found in table 'users': Column 'email' has 100 null values out of 100 rows.
  - Details: {'issues': ["Column 'email' has 100 null values out of 100 rows."]}
- **[FAIL]** Data constraint issues found in table 'users': Column 'date_of_birth' has 100 null values out of 100 rows.; Column 'date_of_birth' has 100 invalid date values out of 100 rows.
  - Details: {'issues': ["Column 'date_of_birth' has 100 null values out of 100 rows.", "Column 'date_of_birth' has 100 invalid date values out of 100 rows."]}
- **[FAIL]** Data constraint issues found in table 'users': Column 'date_onboarded' has 100 null values out of 100 rows.; Column 'date_onboarded' has 100 invalid date values out of 100 rows.
  - Details: {'issues': ["Column 'date_onboarded' has 100 null values out of 100 rows.", "Column 'date_onboarded' has 100 invalid date values out of 100 rows."]}
- **[FAIL]** Data constraint issues found in table 'orders': Column 'order_date' has 100 null values out of 100 rows.; Column 'order_date' has 100 invalid date values out of 100 rows.
  - Details: {'issues': ["Column 'order_date' has 100 null values out of 100 rows.", "Column 'order_date' has 100 invalid date values out of 100 rows."]}
...
- **[PASS]** All data constraints are satisfied for table 'order_items'.
- **[PASS]** All data constraints are satisfied for table 'order_items'.
- **[FAIL]** Data constraint issues found in table 'products': Column 'product_name' has 100 null values out of 100 rows.
  - Details: {'issues': ["Column 'product_name' has 100 null values out of 100 rows."]}
...
- **[PASS]** All foreign key values in 'order_id' of child table 'orders' have matching primary keys in parent table.
